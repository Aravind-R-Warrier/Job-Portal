    ...
    <div className='shadow py-4 '>
        <div className='px-5 flex justify-between items-center '>
            ...
            <div className='flex items-center gap-3'>
                <p className='max-sm:hidden'>Welcome,Aravind</p>
    ...
    <div className='flex items-start'>
        ...
        <div className='inline-block min-h-screen border-r-2'>
            <ul className='flex flex-col items-start pt-5 text-gray-800'>
                ...
                <NavLink className={({isActive})=>`flex items-center p-3 sm:px-6 gap-2 w-full hover:bg-gray-100 ${isActive && 'bg-green-100 border-r-4 border-green-500'}`} to={'/adminDashboard/manage-users'} >
                <img className='min-w-4' src={assets.person_icon} alt="" />
                <p className='max-sm:hidden'>Manage users</p>
                </NavLink>
                <NavLink className={({isActive})=>`flex items-center p-3 sm:px-6 gap-2 w-full hover:bg-gray-100 ${isActive && 'bg-green-100 border-r-4 border-green-500'}`} to={'/adminDashboard/manage-recruiters'}>
                <img className='min-w-4' src={assets.suitcase_icon} alt="" />
                <p className='max-sm:hidden'>Manage Recruiters</p>
                </NavLink>
            </ul>
        </div>
