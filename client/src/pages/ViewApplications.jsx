            ...
            {viewApplicationsPageData.map((application, index) => (
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b text-center flex'>
                  ...
                  <span className='text-center flex items-center'>{application.name}</span>
                </td>
                <td  className='py-2 px-4 w-10 h-10 rounded-full mr-3 max-sm:hidden'>{application.jobTitle}</td>
                <td  className='py-2 px-4 w-10 h-10 rounded-full mr-3 max-sm:hidden'>{application.location}</td>
